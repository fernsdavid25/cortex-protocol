...
This bundle is a *command* bundle: it launches `uvx cortex-mcp`, so it needs
[`uv`](https://docs.astral.sh/uv/) on the machine and the `cortex-mcp` package available
...
npx @anthropic-ai/mcpb pack packaging/mcpb dist/cortex-mcp.mcpb
# optional, for distribution:
npx @anthropic-ai/mcpb sign dist/cortex-mcp.mcpb
```

## Install
Drag `dist/cortex-mcp.mcpb` onto **Claude Desktop** (Settings → Extensions). Desktop prompts
